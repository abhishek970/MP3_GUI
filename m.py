...
class FrameApp(Frame):
    def __init__(self,master):
        ...
        self.b1 = Button(self, text="PLAY MUSIC", command=self.play_music,bg='orangered2', width=40)
        self.b1.grid(row=2, column=0)

        self.b2 = Button(self, text="PREVIOUS SONG", command=self.previous_song,bg='medium orchid1',
                         width=40)
        self.b2.grid(row=4, column=0)

        self.b3 = Button(self, text="PAUSE/PLAY", command=self.toggle,bg='yellow2', width=40)
        self.b3.grid(row=3, column=0)

        self.b4 = Button(self, text="NEXT MUSIC", command=self.next_song,bg='royalblue1', width=40)
        self.b4.grid(row=5, column=0)

        self.b5 = Button(self, text="ADD TO PLAYLIST", command=self.add_to_list,bg='peach puff',
                         width=40)
        self.b5.grid(row=1, column=0)

        self.label1 = Label(self, fg='Black', font=('Helvetica 12 bold italic',10), bg='plum3')
